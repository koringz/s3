(function (foctory) {
    !function (factory) {
        ...
        var CIRCLE_s = 299, SHAPE_s = 300, LINE_s = 298, ARC_s = 297,
            RECT_s = 296, WAVE_s = 295, SECTORS_s = 294, HAT_s = 293,
            HILL_s = 292, ELLIPSE_s = 291;  // 图形类型编号
        var GRADIENT_s = 86, GRADIENT20_s = 85, GRADIENT30_s = 84,
            POINTER_CONFIG_s = 83, START_CONFIG_s = 82, STATE_s = 81,
            POSITION_s = 266, DISTANCE_s = 260,
            SET_s = 499, FREEZE_PROPERTY_s = 999, PLUGIN_s = 1000,
            COVER_2D_PROPERTY_s = 1099, CACHE_s = 1111, RENDER_s = 1299;
        var TOOL_s = 99, POSITION_CONTROL_s = 98, ANIMATION_s = 97, DRAW_s = 96,
            TRANSFER_s = 95, RENDER_ENGINE_s = 94, SCENE_s = 89, AMOUNT_s = 88,
            CONTEXT_s = 250, MATH_s = 219;
        var WAVE_SHAPE_s = 240, CIRCLE_SHAPE_s = 239, HILL_SHAPE_s = 232,
            VALIDATE_DRAW_PROPERTY_s = 280, COMPARE_PROPERTY_s = 279;
            ...
            init = new (function (_={a:[], puts:put}) {
                return function (mySelf={}) {
                    ...
                    1: function (closure) {
                        ...
                        _shape = closure[1][SHAPE_s];      // 图形基类
                        _circle = closure[1][CIRCLE_s];     // 圆形
                        _line = closure[1][LINE_s];         // 线条
                        _arc = closure[1][ARC_s];           // 弧
                        _rect = closure[1][RECT_s];         // 矩形
                        _wave = closure[1][WAVE_s];         // 波纹
                        _sectors = closure[1][SECTORS_s];   // 扇形
                        _hat = closure[1][HAT_s];           // 帽形
                        _hill = closure[1][HILL_s];         // 山形
                        _ellipse = closure[1][ELLIPSE_s];   // 椭圆
