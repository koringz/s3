(function (foctory) {
    !function (factory) {
        ...
        */
        ...
        (function () {
            var _arraySlice, _tool, _pos, _animation, _draw, _transfer, _renderEngine, _scene, _gradient, _gradient20, _pointerConfig, _gradient30, _startConfig, _state, _circle, _distance, _position, _waveShape, _shape, _line, _arc, _rect, _wave, _sectors, _hat, _hill, _ellipse, _validateDraw, _context2d, _compareProperty, _circleShape, _math, _hillShape, Aw, Al, _set, _freezeProperty, _cover2d, _plugin, _render, // functional property
            ...
            init = (function () {
                    ...
                    {},
                    {
                        ...
                        300: function () {
                            ...
                            this.calculationProperty = {
                                createCircle: dataArray[1][CIRCLE_SHAPE_s].createCircle,
                            };
                ...
                _tool = dataArray[1][TOOL_s];
                _pos = dataArray[1][POSITION_CONTROL_s];
                _draw = dataArray[1][DRAW_s];
                _transfer = dataArray[1][TRANSFER_s];
                _renderEngine = dataArray[1][RENDER_ENGINE_s];
                _scene = dataArray[1][SCENE_s];
                _gradient = dataArray[1][GRADIENT_s];
                _animation = dataArray[1][ANIMATION_s];
                _gradient20 = dataArray[1][GRADIENT20_s];
                _gradient30 = dataArray[1][GRADIENT30_s];
                _pointerConfig = dataArray[1][POINTER_CONFIG_s];
                _startConfig = dataArray[1][START_CONFIG_s];
                _state = dataArray[1][STATE_s];
                _shape = dataArray[1][SHAPE_s];
                _circle = dataArray[1][CIRCLE_s];
                _line = dataArray[1][LINE_s];
                _arc = dataArray[1][ARC_s];
                _rect = dataArray[1][RECT_s];
                _wave = dataArray[1][WAVE_s];
                _sectors = dataArray[1][SECTORS_s];
                _hat = dataArray[1][HAT_s];
                _hill = dataArray[1][HILL_s];
                _ellipse = dataArray[1][ELLIPSE_s];
                _validateDraw = dataArray[1][VALIDATE_DRAW_PROPERTY_s];
                _compareProperty = dataArray[1][COMPARE_PROPERTY_s];
                _position = dataArray[1][POSITION_s];
                _distance = dataArray[1][DISTANCE_s];
                _context2d = dataArray[1][CONTEXT_s];
                _waveShape = dataArray[1][WAVE_SHAPE_s];
                _circleShape = dataArray[1][CIRCLE_SHAPE_s];
                _hillShape = dataArray[1][HILL_SHAPE_s];
                _math = dataArray[1][MATH_s];
                _set = dataArray[1][SET_s];
                _freezeProperty = dataArray[1][FREEZE_PROPERTY_s];
                _plugin = dataArray[1][PLUGIN_s];
                _cover2d = dataArray[1][COVER_2D_PROPERTY_s];
                _render = dataArray[1][RENDER_s];
                // 默认值 - 暂时无效
                speed = 0.1;
                times = 0;
                logger = false;
                processing = 1;
                requestAnimation = win.requestAnimationFrame || win.webkitRequestAnimationFrame
                    || win.mozRequestAnimationFrame || win.msRequestAnimationFrame
                    || function (callback) { setTimeout(callback, 1000 / 60); };

                // 初始化 category 映射表
                category = [Object, {
                    99: 'tool', 98: 'pos', 97: 'animation', 96: 'draw',
                    95: 'transfer', 94: 'render', 89: 'scene', 88: 'amount',
                    86: 'createGradient', 85: 'createGradient20', 84: 'createGradient30',
                    83: 'pointerConfig', 82: 'startConfig', 81: 'state',
                    300: 'shape', 299: 'circle', 298: 'line', 297: 'arc', 296: 'rect',
                    295: 'wave', 294: 'sectors', 293: 'hat', 292: 'hill', 291: 'ellipse',
                    280: 'validateDrawProperty', 266: 'position', 279: 'compareProperty',
                    260: 'distance', 250: 'context', 240: 'waveShape', 239: 'circleShape',
                    232: 'hillShape', 231: 'ellipseShape', 219: 'math',
                    499: 'set', 999: 'freezeProperty', 1000: 'plugin',
                    1099: 'cover2DProperty', 1111: 'cache', 1299: 'render'
                }, {
        ...
        */
        (function () {
            var __pool = s3.init;
            var __store = s3.category;
            __pool[1][TOOL_s].prototype.constructor = __store[1][TOOL_s];
            __store[1][TOOL_s] = __pool[1][TOOL_s];
            Object.assign(__store[1][TOOL_s].prototype, {
                initialize: function () {
                    return this,
                ...
                amount: function (params) {
                    var amounts = new __store[1][AMOUNT_s](params);
                        ...
                        graphics: {
                            ...
                            addComponent: function () {
                                ...
                                for (var k = SHAPE_RANGE_START; k > SHAPE_RANGE_END; k--)
                                    if (k in __store[1])
                                        try {
                                            if (__store[1][k]?.prototype?.constructor === args[0]) {
                                                getPropBindObject = k;
                                                break;
                                            } else
                                                continue;
                                ...
                                var utils = new __store[1][getPropBindObject](that.pipe);
            ...
            Object.defineProperties(__store[1][TOOL_s].prototype, {
                scene: {
                    get: function () {
                        var that = this;
            ...
            // name = 'amount()'
            __pool[1][AMOUNT_s].prototype.constructor = __store[1][AMOUNT_s];
            __store[1][AMOUNT_s] = __pool[1][AMOUNT_s];
            Object.assign(__store[1][AMOUNT_s].prototype, {
            ...
            Object.defineProperties(__store[1][AMOUNT_s].prototype, {
                value: {
                    get: function () {
            ...
            // pointerconfig = '()'
            __pool[1][POINTER_CONFIG_s].prototype.constructor = __store[1][POINTER_CONFIG_s];
            __store[1][POINTER_CONFIG_s] = __pool[1][POINTER_CONFIG_s];
            Object.assign(__store[1][POINTER_CONFIG_s].prototype, {
                initialize: function () {
                    return this.val
                }
            });
            Object.defineProperties(__store[1][POINTER_CONFIG_s].prototype, {
                'type': {
                    get: function () {
                        return this.TYPE
                    },
            ...
            // startconfig = '()'
            __pool[1][START_CONFIG_s].prototype.constructor = __store[1][START_CONFIG_s];
            __store[1][START_CONFIG_s] = __pool[1][START_CONFIG_s];
            Object.assign(__store[1][START_CONFIG_s].prototype, {
                initialize: function () {
                    return this.val
                }
            });
            Object.defineProperties(__store[1][START_CONFIG_s].prototype, {
                'speed': {
                    get: function () {
                        return this.SPEED
                    },
            ...
            // setState = '()'
            __pool[1][STATE_s].prototype.constructor = __store[1][STATE_s];
            __store[1][STATE_s] = __pool[1][STATE_s];
            Object.assign(__store[1][STATE_s].prototype, {
                initialize: function () {
                    return this.val
                }
            });
            Object.defineProperties(__store[1][STATE_s].prototype, {
                'setState': {
                    set: function (val) {
                        this.state = val
                    }
            ...
            s3.space._tool = __store[1][TOOL_s];
            s3.node._pointerconfig = __store[1][POINTER_CONFIG_s];
            s3.node._startConfig = __store[1][START_CONFIG_s];
            s3.node._state = __store[1][STATE_s];
        })();
        /*
        *2D prototype
        ...
        */
        (function () {
            var __pool = s3.init;
            var __store = s3.category;
            __pool[1][CONTEXT_s].prototype.constructor = __store[1][CONTEXT_s];
            __store[1][CONTEXT_s] = __pool[1][CONTEXT_s];
            Object.assign(__store[1][CONTEXT_s].prototype, {
                initialize: function () {
                    return this,
            ...
            Object.defineProperties(__store[1][CONTEXT_s].prototype, {
                ctx: {
                    get: function () {
                        return this.data
                    },
            ...
            s3.node._context = __store[1][CONTEXT_s];
        })();
        // _set
        (function () {
            var __pool = s3.init;
            var __store = s3.category;
            __pool[1][SET_s].prototype.constructor = __store[1][SET_s];
            __store[1][SET_s] = __pool[1][SET_s];
            Object.assign(__store[1][SET_s].prototype, {
                initialize: function () {
                    return this,
        ...
        */
        (function () {
            var __pool = s3.init;
            var __store = s3.category;
            __pool[1][CIRCLE_s].prototype.constructor = __store[1][CIRCLE_s];
            __store[1][CIRCLE_s] = __pool[1][CIRCLE_s];
            Object.assign(__store[1][CIRCLE_s].prototype, {
                initialize: function () {
                    return this,
                    __store[1][CIRCLE_s].call(this, arguments),
                    __store[1][CIRCLE_s].prototype
                },
            ...
            Object.defineProperties(__store[1][CIRCLE_s].prototype, {});
            s3.tween._circle = __store[1][CIRCLE_s];
        })();
        /*
        *@rect methods
        ...
        */
        (function () {
            var __pool = s3.init;
            var __store = s3.category;
            __pool[1][RECT_s].prototype.constructor = __store[1][RECT_s];
            __store[1][RECT_s] = __pool[1][RECT_s];
            Object.assign(__store[1][RECT_s].prototype, {
                initialize: function () {
                    return this,
                    __store[1][RECT_s].call(this, arguments),
                    __store[1][RECT_s].prototype
                },
                draw: function (ctx, getShapeProperty) {
                    var that = this;
                    var can = this.data[0];
            ...
            Object.defineProperties(__store[1][RECT_s].prototype, {});
            s3.tween._rect = __store[1][RECT_s];
        })();
        (function () {
            var __pool = s3.init;
            var __store = s3.category;
            __pool[1][CIRCLE_SHAPE_s].prototype.constructor = __store[1][CIRCLE_SHAPE_s];
            __store[1][CIRCLE_SHAPE_s] = __pool[1][CIRCLE_SHAPE_s];
            __store[1][CIRCLE_SHAPE_s].createCircle = function (options, cTimes) {
                return new s3.node._createCircle;
            }
            Object.assign(__store[1][CIRCLE_SHAPE_s].prototype, {
                initialize: function () {
                    return this,
                    __store[1][CIRCLE_SHAPE_s].call(this, arguments),
                    __store[1][CIRCLE_SHAPE_s].prototype
                },
            });
            s3.node._createCircle = __store[1][CIRCLE_SHAPE_s];
        })();
        (function () {
            var __pool = s3.init;
            var __store = s3.category;
            __pool[1][SHAPE_s].prototype.constructor = __store[1][SHAPE_s];
            __store[1][SHAPE_s] = __pool[1][SHAPE_s];
            Object.assign(__store[1][SHAPE_s].prototype, {
                initialize: function (argument) {},
            });
            Object.defineProperties(__store[1][SHAPE_s].prototype, {});
            s3.space._shape = __store[1][SHAPE_s];
        })();
