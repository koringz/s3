        ...
        (function () {
            ...
            Object.assign(s3.category[1][CIRCLE_s].prototype, {
                ...
                draw: function (ctx, getShapeProperty) {
                    ...
                    this._readyRender(props, Object.assign(shapeProperty, {
                        x1: cw,
                        y1: ch
                    }));
                ...
                _readyRender: function (props, shapeProperty) {
                    ...
                    this._startRender(props.property, shapeProperty)
                },
                // ===== 启动渲染 =====
                _startRender: function (particle, shapeProperty) {
                    var staticGroups  = {};
                    var dynamicGroups = {};
                    this.hasMoving = false;
                    this.hasStatic = false;
                    ...
                    for (var j = 0, len = particle.length; j < len; j++) {
                        this.mergeProperties(particle[j], shapeProperty);   // ★ 只合并一次（原来是 2 次）
