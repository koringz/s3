    ...
    !function (factory) {
        ...
        */
        ...
        (function () {
            ...
            put = {}, counts = 0, category = null, init = void {};
                ...
                _tool = category[1][TOOL_s];
                _pos = category[1][POSITION_CONTROL_s];
                _draw = category[1][DRAW_s];
                _transfer = category[1][TRANSFER_s];
                _renderEngine = category[1][RENDER_ENGINE_s];
                _scene = category[1][SCENE_s];
                _gradient = category[1][GRADIENT_s];
                _animation = category[1][ANIMATION_s];
                _gradient20 = category[1][GRADIENT20_s];
                _gradient30 = category[1][GRADIENT30_s];
                _pointerConfig = category[1][POINTER_CONFIG_s];
                _startConfig = category[1][START_CONFIG_s];
                _state = category[1][STATE_s];
                _shape = category[1][SHAPE_s];
                _circle = category[1][CIRCLE_s];
                _line = category[1][LINE_s];
                _arc = category[1][ARC_s];
                _rect = category[1][RECT_s];
                _wave = category[1][WAVE_s];
                _sectors = category[1][SECTORS_s];
                _hat = category[1][HAT_s];
                _hill = category[1][HILL_s];
                _ellipse = category[1][ELLIPSE_s];
                _validateDraw = category[1][VALIDATE_DRAW_PROPERTY_s];
                _compareProperty = category[1][COMPARE_PROPERTY_s];
                _position = category[1][POSITION_s];
                _distance = category[1][DISTANCE_s];
                _context2d = category[1][CONTEXT_s];
                _waveShape = category[1][WAVE_SHAPE_s];
                _circleShape = category[1][CIRCLE_SHAPE_s];
                _hillShape = category[1][HILL_SHAPE_s];
                _math = category[1][MATH_s];
                _set = category[1][SET_s];
                _freezeProperty = category[1][FREEZE_PROPERTY_s];
                _plugin = category[1][PLUGIN_s];
                _cover2d = category[1][COVER_2D_PROPERTY_s];
                _renders = category[1][RENDER_s];
                // 默认值 - 暂时无效
                speed = 0.1;
                times = 0;
                logger = false;
        ...
        */
        (function () {
            ...
            __store[1][TOOL_s].prototype.constructor = TOOL_s;
            ...
            // name = 'amount()'
            __store[1][AMOUNT_s].prototype.constructor = AMOUNT_s;
            ...
            __store[1][POINTER_CONFIG_s].prototype.constructor = POINTER_CONFIG_s;
            ...
            // startconfig = '()'
            __store[1][START_CONFIG_s].prototype.constructor = START_CONFIG_s;
            ...
            __store[1][STATE_s].prototype.constructor = STATE_s;
        ...
        */
        (function () {
            var __store = s3.category;
            __store[1][CONTEXT_s].prototype.constructor = CONTEXT_s;
        ...
        (function () {
            var __store = s3.category;
            __store[1][SET_s].prototype.constructor = SET_s;
        ...
        */
        (function () {
            var __store = s3.category;
            __store[1][CIRCLE_s].prototype.constructor = CIRCLE_s;
        ...
        */
        (function () {
            var __store = s3.category;
            __store[1][RECT_s].prototype.constructor = RECT_s;
        ...
        (function () {
            var __store = s3.category;
            __store[1][CIRCLE_SHAPE_s].prototype.constructor = CIRCLE_SHAPE_s;
        ...
        (function () {
            var __store = s3.category;
            __store[1][SHAPE_s].prototype.constructor = SHAPE_s;
