        ...
        (function () {
            ...
            Object.assign(s3.category[1][CIRCLE_s].prototype, {
                ...
                draw: function (ctx, getShapeProperty) {
                    ...
                    var propertybgcolor = props.bg;
                    this.callState = new s3.node._state();
                    this.reRender(props.property, {
                        bg: propertybgcolor
                ...
                reRender: function (particle, getCollectionProperty, shapeProperty) {
                    ...
                    this.excuteReRender(particle, shapeProperty)
                },
