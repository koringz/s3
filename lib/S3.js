(function (foctory) {
    !function (factory) {
        ...
        */
        (function () {
            ...
            Object.assign(__store[1][TOOL_s].prototype, {
                initialize: function () {
                    return this,
                    new __store[1][TOOL_s](arguments[0].getContext('2d'))
                },
                createGradient: function () {
        ...
        */
        ...
        // _set
        (function () {
            var __store = s3.category[1];
            __store[SET_s].prototype.constructor = SET_s;
            Object.assign(__store[SET_s].prototype, {
                initialize: function () {
                    return this,
                    __store[SET_s].call(this, arguments),
                    new __store[SET_s](arguments[0])
                },
                attr: function (attr) {
        ...
        */
        ...
        (function () {
            ...
            Object.assign(__store[1][ALGO_s].prototype, algoPrototype);
            // 如果需要直接挂在 s3.space 上供插件注册
            s3.space._algo = __store[1][ALGO_s];
        })();
