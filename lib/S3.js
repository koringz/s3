(function (foctory) {
    !function (factory) {
        ...
        */
        ...
        (function () {
            var _arraySlice, _tool, _pos, _animation, _draw, _transfer, _renderEngine, _scene, _gradient, _gradient20, _pointerConfig, _gradient30, _startConfig, _state, _circle, _distance, _position, _waveShape, _shape, _line, _arc, _rect, _wave, _sectors, _hat, _hill, _ellipse, _validateDraw, _context2d, _compareProperty, _circleShape, _math, _hillShape, Aw, Al, _set, _freezeProperty, _cover2d, _plugin, _renders, // functional property
            ...
            init = (function () {
                ...
                category = [Object, {
                    ...
                    createGradient20: 'createGradient20',
                    createGradient30: 'createGradient30',
                    ...
                    hill: 'hill',
                    ellipse: 'ellipse',
                    validateDrawProperty: 'validateDrawProperty',
                    position: 'position',
                    ...
                    plugin: 'plugin',
                    cover2DProperty: 'cover2DProperty',
                    cache: 'cache',
                    render: 'render'
                },
                    {
                    ...
                    return {
                        graphics: {
                            ...
                            addComponent: function () {
                                ...
                                try {
                                    if (__store[1][SHAPE_RANGE_Name]?.prototype?.constructor === SHAPE_RANGE_Name) {
