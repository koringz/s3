    ...
    !function (factory) {
        ...
        */
        ...
        function body(options) {
            this.mount = new Shape();
            this.dist = new Array();
            this.bool = false;
            return this.dist.push(options) && !this.bool
        }
        body.prototype.component = function (str, options) {
            var dist = this.dist[0];
            var tool = this.mount.tool(dist);
                    ...
                    return {
                        graphics: {
                            ...
                            addComponent: function () {
                                ...
                                var utils = new s3.tween[getPropBindObject](that.pipe);
