        ...
        (function () {
            ...
            Object.assign(s3.category[1][TOOL_s].prototype, {
                ...
                render: function (bool) {
                    var that = this;
                    that.life.forEach(function(item) {
        ...
        (function () {
            ...
            Object.assign(s3.category[1][CIRCLE_s].prototype, {
                ...
                draw: function (ctx, getShapeProperty) {
                    ...
                    this.reRender(props, Object.assign(shapeProperty, {
                        x1: cw,
                        y1: ch
                    }))
                    ...
                    var that = this;
                    return {
                        changedState: this.hasMoving == this.hasStatic ? 0 : 1,
                        reloadAnimation: function () {
                            that.reRender(props, shapeProperty)
                        }
                    }
                },
                reRender: function (props, shapeProperty) {
                    ...
                    this.excuteReRender(props.property, shapeProperty)
                },
                excuteReRender: function (particle, shapeProperty) {
                    var groups = {};
                    ...
                    this.ctx2d.hook2D('closePath');
                    this.ctx2d.hook2D('restore')
                },
