(function(foctory) {
    !function(factory) {
        ...
        */
        ...
        (function() {
            var Am, At, Atp, Ata, Atd, Att, Atr, Ats, Ata, Atc, Atc20, Atpc, Atc30, Atsc, At_s, Ac, Acd, Acp, Acw, Ashape, Acls, Acas, Acrs, Acws, Acss, Achs, AchIs, Aces, Acvdp, Ac_2d, Accp, Ac_, Acm, Ach, Aw, Al, Aset, Af, Bc, Bp, Br,
            // functional property
            ...
            init = new(function(_ = {a: [],puts: put}) {
                return function(mySelf = {}) {
                    ...
                    1 : function(closure) {
                        ...
                        At = closure[1][99]; Atp = closure[1][98]; Ata = closure[1][97]; Atd = closure[1][96]; Att = closure[1][95]; Atr = closure[1][94]; Ats = closure[1][89]; Ata = closure[1][87]; Atc = closure[1][86]; Atc20 = closure[1][85]; Atc30 = closure[1][84]; Atpc = closure[1][83]; Atsc = closure[1][82]; At_s = closure[1][81];
                        Ashape = closure[1][300];
                        Ac = closure[1][299]; Acls = closure[1][298]; Acas = closure[1][297]; Acrs = closure[1][296]; Acws = closure[1][295]; Acss = closure[1][294]; Achs = closure[1][293]; AchIs = closure[1][292]; Aces = closure[1][291]; Acvdp = closure[1][280]; Accp = closure[1][279]; Acp = closure[1][266]; Acd = closure[1][260]; Ac_2d = closure[1][250]; Acw = closure[1][240]; Ac_ = closure[1][239]; Ach = closure[1][232]; Acm = closure[1][219];
                        Aset = closure[1][499];
                        Af = closure[1][999];
                        Bp = closure[1][1000]; Bc = closure[1][1099]; Br = closure[1][1299]; },
                    2 : function() {
                    ...
                    3 : function() {
                        ...
                        {
                            99 : 'tool', 98 : 'pos', 97 : 'animation', 96 : 'draw', 95 : 'transfer', 94 : 'render', 89 : 'scene', 88 : 'amount', 86 : 'createGradient', 85 : 'createGradient20', 84 : 'createGradient30', 83 : 'pointerConfig', 82 : 'startConfig', 81 : 'state', 300 : 'shape', 299 : 'circleShape', 298 : 'lineShape', 297 : 'arcShape', 296 : 'rectShape', 295 : 'waveShape', 294 : 'sectorsShape', 293 : 'hatShape',292 : 'hillShape',291 : 'ellipseShape',280 : 'validateDrawProperty',266 : 'position',279 : 'compareProperty',260 : 'distance', 250 : 'context', 240 : 'wave', 239 : 'circle', 232 : 'hill', 231 : 'ellipse', 219 : 'math', 499 : 'set', 999 : 'freezeProperty', 1000 : 'plugin', 1099 : 'cover2DProperty', 1111 : 'cache', 1299 : 'render', },
                        // closure
                        {
                            1 : 'get',
                            2 : 'set',
                ...
                },
                {
                    ...
                    299 : function() {
                        ...
                        this.iterator = {};
                        this.callState = {};
                        this.setState = function (val, option) { that.callState.setState = val }
        ...
        body.prototype.component = function (str, options) {
            ...
            addComponent.start({speed: 0.9,open: true})
        ...
        (function() {
                ...
                manager: function() {
                    ...
                    return {
                        graphics: {
                            config: {
                                set: (function() {
                                    var properties = {type: 'Array', property: []}
            ...
            q[0].defineProperties(o[1][99].prototype, {
                scene: {
                    ...
                    set: function(value) {
                        ...
                        for (var k in originalProperty) this.newEmpty.push(k);
                    ...
                    get: function(x) {
                        ...
                        return {
                            addChild: function(options) {
                                var _arr = [], depthCall = options.depthCall;
                                ...
                                var stream = function (option) {
                                    if (options) return maybeLoop.streaming()
                                }
                                return this, that.life.push({ stream })
                            },
                        }
                    },
                    set: function(value) {
            ...
            q[0].assign(o[1][88].prototype, {
                handleModule: function(options) {
                    ...
                    var arrEmpty = [];
                    for (var j = 0; j < size; j++) arrEmpty.push(acceptData[j])
                    return arrEmpty
                },
                set: function(param) {
                    this.getValue = param;
        ...
        (function() {
            ...
            q[0].assign(o[1][299].prototype, {
                ...
                draw: function(ctx, getShapeProperty) {
                    ...
                    this.reRender(collectionProperty.property, { bg: propertybgcolor }, ctx2M, Object.assign(shapeProperty, {x1: cw, y1: ch}), that)
                    ...
                    return {
                        ...
                        reloadAnimation: function () {
                            that.reRender(that.collection[0].characteristic.property, { bg: propertybgcolor }, ctx2M, shapeProperty, that)
                        }
                    }
                },
                ...
                excuteReRender: function  (particle, ctx2M, shapeProperty, that) {
                    for (var j = 0, len = particle.length; j < len; j++) {
                        ...
                        if (this.iterator.motion === shapeProperty.motion && this.iterator.bMoveMode ? ( this.iterator.motion === shapeProperty.motion || this.isMoveModel !== this.iterator.motion) : this.iterator.motion !== shapeProperty.motion ? false: !0 ) {
                            this._arc(ctx2M, null);
                            this.notNeed = false;
                            this.noMotionArrCount.push(j)
                        }
                        else this.loop(ctx2M, shapeProperty, j, that), this.need = true;
                        ctx2M.hook2D('fillStyle', { color: this.iterator.color });
                        ctx2M.hook2D('fill');
                ...
                reRender: function  (particle, getCollectionProperty, ctx2M, shapeProperty, that) {
                    ctx2M.hook2D('fillStyle', { color: getCollectionProperty.bg || shapeProperty.bg });
                ...
                removeCommon: function (acceptCollection, noMotionArrCount) {
                    ...
                    for (var i = 0; i < acceptCollection.length; i++) {
                        if(acceptCollection[i] instanceof Object) na.push(acceptCollection[i])
                        else continue;
                    }
                    this.collection[0].characteristic.property = na
                },
                // match module
                matchModules: function (options) {
                    var modules = null;
                    for (var i = 0, moveModel = this.moveModel, ml = moveModel.length; i < ml; i++) {
                        if (options == moveModel[i]){
                            modules = options;
                            break;
                        }
                        else continue;
                ...
                Excute2DEngine: function () {
                    ...
                    var params = { can: args[0], config: args[1], constroll: args[2] }
                    ...
                    if (this.o_OPEN) this.s_SPEED = params.constroll.speed;
